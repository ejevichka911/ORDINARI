...
<head>
    ...
    <title>Орден Святого Равноапостольного Великого Князя Владимира</title>
    ...
    <link rel="stylesheet" href="css/styles.css"> <!-- Подключаем файл стилей -->
...
<body>
  ...
  <div class="window">
    <div class="page-title">
      <h1 class="text">Орден Святого Равноапостольного Великого Князя Владимира</h1>
    </div>
    <div id="products" class="products"></div>
  </div>
  
    <script src="js/scripts.js"></script> <!-- Подключаем файл скрипта -->
