...
<head>
    ...
    <title>Орден Победы (вариант 2) с футляром</title>
        ...
        <div class="shap-mon-bottom">
            ...
            <div class="shap-mon-right">
                <div class="shap-mon-right-info">
                    <div class="info-zag" id="product-name">Орден Победы (вариант 2) с футляром</div>
                    <div class="info-article" id="product-article">Ор.П-2</div>
